...
Stuypedia is a handy tool for Stuyvesant Students used to gauge coursework and teachers teaching each course. Students will be able to view overall class rating, average homework workload (hrs). difficulty, enjoyment, average test difficulty, along with general comments and advice about taking the course. Data are displayed when students are viewing each class section. 
